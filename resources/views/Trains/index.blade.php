                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            @if (auth()->user()->role == 1 || auth()->user()->role == 2)
                                <a href="{{ url('/Trains/' . $train->id . '/edit') }}" title="Edit Train Routes"><button class="btn btn-primary btn-sm"><i class="fas fa-edit" aria-hidden="true"></i> Edit</button></a>
                            @endif

                            @if (auth()->user()->role == 1)
                                <form method="POST" action="{{ url('/Trains' . '/' . $train->id) }}" accept-charset="UTF-8" style="display:inline">
                                    {{ method_field('DELETE') }}
                                    {{ csrf_field() }}
